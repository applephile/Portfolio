...
<body>
	...
	<section>
		...
		<div class="regSize">
			<div class="register">
				<form action="joinText" method="post" class="fregister" name="frmCheck">
					<p>
...
이 약관은 울산축구클럽리그 가 운영하는 울산축구클럽리그(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리?의무 및 책임사항을 규정함을 목적으로 합니다.

  ※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」

제2조(정의)

  ① “몰”이란 울산축구클럽리그회사가 재화 또는 용역(이하 “재화등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
제24조(재판권 및 준거법)
  ...
  ② “몰”과 이용자간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
						...
						<label><input type="checkbox" class="checkBox" name="regBox"></label>
					</div>
					...
					<div class="reg-checkAll">
						<label>
							<input type="checkbox" name="checkboxAll" class="checkBox checkAll" value="checkAll" onclick="checkAll(this)">
							회원가입 약관에 모두 동의합니다.
						</label>
					</div>
					
					<div class="btn-confirm">
						<a href="main" class="btn-close">취소</a>
						<button type="submit" class="btn-submit" onclick="return fn_submit1();">회원가입</button>
					</div>
				</form>
			</div>
		</div>
